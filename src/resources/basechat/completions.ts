...
import * as ChatCompletionsAPI from 'openai/resources/basechat/completions';
...
export class Completions extends APIResource {
  ...
  create(
    ...
    return this.post('/v1/chat', { body, ...options, stream: body.stream ?? false, isBaseModel: true }) as
      | APIPromise<ChatCompletion>
      | APIPromise<Stream<ChatCompletionChunk>>;
  }
  createBase(body: any, options?: any) {
    return this.post('/v1/chat', { body, ...options, stream: body.stream ?? false, isBaseModel: true });
  }
}
...
export interface ChatCompletionCreateParamsBase {
   ...
   */
  prompt: ChatPrompt;
  history: Array<ChatPrompt>;

  model_name: (string & {}) | 'Baichuan2' | 'gpt-4-1106-preview' | 'gpt-4-vision-preview' | 'gpt-4';
